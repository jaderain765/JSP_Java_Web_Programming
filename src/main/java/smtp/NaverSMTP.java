 ...
 * 
 * public class NaverSMTP { private final Properties serverInfo; private final
 * Authenticator auth;
 * 
 * public NaverSMTP() { serverInfo = new Properties();
 * serverInfo.put("mail.smtp.host", "smtp.naver.com");
 * serverInfo.put("mail.smtp.port", "465");
 * serverInfo.put("mail.smtp.starttls.enable", "true");
 * serverInfo.put("mail.smtp.auth", "true"); serverInfo.put("mail.smtp.debug",
 * "true"); serverInfo.put("mail.smtp.socketFactory.port", "465");
 ...
 * return new PasswordAuthentication("leehw1412", "leesg2582"); } }; }
 * 
 * public void emailSending(Map<String, String> mailInfo) throws
 * MessagingException { Session session = Session.getInstance(serverInfo, auth);
 * session.setDebug(true);
 * 
 * MimeMessage msg = new MimeMessage(session); msg.setFrom(new
 * InternetAddress(mailInfo.get("from")));
 * msg.addRecipient(Message.RecipientType.TO, new
 * InternetAddress(mailInfo.get("to")));
